...
class RuleManage {
    ...
    // 1横 2竖 3撇 4捺
    public static JudgeAllSuccess():JudgePoint {
        var pointResult:JudgePoint;
        // 处理1横向
    ...
    // 横向下一个小球
    public static Judge1Next(point:egret.Point):egret.Point {
        point.x++;
        if (point.x > 8) {
            point.x = -1;
            point.y = -1;
    ...
    // 横向判断结果
    public static Judge1Success():JudgePoint {
        var nNumPoint:number;
        var pointIndex:egret.Point = new egret.Point();
        var pointJudge:JudgePoint = new JudgePoint();
        pointJudge.nType = 1;
    ...
    // 竖向下一个小球
    public static Judge2Next(point:egret.Point):egret.Point {
        point.y++;
        if (point.y > 8) {
            point.x = -1;
            point.y = -1;
    ...
    // 竖向判断结果
    public static Judge2Success():JudgePoint {
        var nNumPoint:number;
        var pointIndex:egret.Point = new egret.Point();
        var pointJudge:JudgePoint = new JudgePoint();
        pointJudge.nType = 2;
    ...
    // 撇向下一个小球
    public static Judge3Next(point:egret.Point):egret.Point
    {
        point.x--;
        point.y++;
    ...
    // 撇向判断结果
    public static Judge3Success():JudgePoint {
        var nNumPoint:number;
        var pointIndex:egret.Point = new egret.Point();
        var pointJudge:JudgePoint = new JudgePoint();
        pointJudge.nType = 3;
    ...
    // 捺向下一个小球
    public static Judge4Next(point:egret.Point):egret.Point
    {
        point.x++;
        point.y++;
    ...
    // 捺向判断结果
    public static Judge4Success():JudgePoint {
        var nNumPoint:number;
        var pointIndex:egret.Point = new egret.Point();
        var pointJudge:JudgePoint = new JudgePoint();
        pointJudge.nType = 4;
