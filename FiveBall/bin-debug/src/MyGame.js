...
var MyGame = (function (_super) {
    ...
    MyGame.prototype.onAddToStaget = function () {
        DataManage._nScore = 0;

        this.createGameTable();
    };

    MyGame.prototype.createGameTable = function () {
        // 加入Game精灵
    ...
    MyGame.prototype.initData = function () {
        for (var i = 0; i < 81; i++) {
    ...
    // 随即诞生三个小球
    MyGame.prototype.createRandThreeBall = function () {
        for (var i = 0; i < 3; i++) {
            var nColor;
            var pointEmpty;
    ...
    // 测试显示
    MyGame.prototype.ShowRect = function () {
        var point;
    ...
    // 清理小球，更新分数
    MyGame.prototype.ClearAndScore = function () {
        var judge;
        var nTmpNumber;
    ...
    // 判断游戏是否结束
    MyGame.prototype.isGameOver = function () {
    ...
    MyGame.prototype.RemoveMyBall = function (nDoIndex) {
        this.sprGame.removeChild(DataManage.sprBall[nDoIndex]);
    };

    MyGame.prototype.disposeClickMsg = function (evt) {
        var pointEvent;
    ...
    // 点击棋盘消息响应
    MyGame.prototype.onClickChess = function (evt) {
        var pointChess;
    ...
    // 移动小球处理函数
    MyGame.prototype.MoveToBall = function (pointNew) {
        var nNumberOld;
        nNumberOld = DataManage.getNumberByXY(this._pointClicked);
        console.log("Old Number:" + String(nNumberOld));
        var nIndexOld;
...
MyGame.prototype.__class__ = "MyGame";
